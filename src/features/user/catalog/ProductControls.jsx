...
const BackButton = () => {
  return (
    <button
      className="py-3 w-30 text-sm text-center text-black border-2 border-solid border-(--Color---6,#CACDD8) shrink-0 max-md:px-5 hover:scale-105 hover:border-blue-600 hover:text-blue-600 transition duration-500"
...
const ItemsCounter = ({ itemsShown, totalItems }) => {
  return (
    <p className="px-3 py-3 border-2 border-solid border-(--Color---6,#CACDD8) text-black max-md:pr-5 max-md:max-w-full">
...
const DisplayControl = () => {
  ...
  return (
    <div className="flex text-center">
      <button
        className="flex gap-2 px-5 py-3 rounded-sm border-2 border-solid border-(--Color---6,#CACDD8) max-md:pl-5"
...
const SortControl = ({ onSortChange }) => {
  ...
  return (
    <div className="flex text-center">
      <select 
        className="px-5 py-3 rounded-sm border-2 border-solid border-(--Color---6,#CACDD8)"
...
const ViewToggle = () => {
  return (
    <img
      src="/Grid.svg"
      className="object-contain shrink-0 ml-0.5 max-w-full aspect-[2.2] w-27.5"
